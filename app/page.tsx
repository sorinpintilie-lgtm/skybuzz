            ...
            {visibleCards.map((card, index) => (
              ...
              >
                ...
                <p className="mt-4 text-[13px] leading-relaxed text-white/62 sm:text-sm">
                  <span className="font-medium text-white/76">Proof:</span> {card.proof}
                </p>
              </motion.article>
            ))}
          </div>
        ...
        <header className="sticky top-0 z-40 border-b border-white/10 bg-black/36 backdrop-blur-xl supports-[backdrop-filter]:bg-black/28">
          ...
          >
            ...
            <aside
              ...
              className={[
                "absolute right-0 top-0 flex h-full w-[min(88vw,360px)] flex-col border-l border-white/12 bg-[rgba(5,5,5,0.96)] p-4 shadow-[-16px_0_48px_rgba(0,0,0,0.45)] backdrop-blur-2xl transition-transform duration-300",
